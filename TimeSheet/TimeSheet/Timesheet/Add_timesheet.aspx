<%@ Page Title="" Language="C#" MasterPageFile="~/Emp/Employee_main.master" AutoEventWireup="true" CodeBehind="Add_timesheet.aspx.cs" Inherits="TimeSheet.Timesheet.Add_timesheet" %>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="295px" Width="1062px">
        <p style="text-align: left">
            ...
            <asp:Panel ID="Panel3" runat="server" style="position: absolute; top: 482px; left: 392px; height: 52px; width: 111px; z-index: 3">
                <asp:Button ID="addTimesheet" runat="server" Text="Add" Width="85px" Height="33px" />
            </asp:Panel>
            <p>
            </p>
            <p>
