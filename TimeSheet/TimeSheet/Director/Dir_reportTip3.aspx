    ...
    <asp:Panel ID="Panel2" runat="server" style="position: relative; top: -166px; left: 36px; width: 614px; height: 178px; z-index: 1;">
        <table style="width: 105%; height: 169px; margin-right: 19px;">
            <tr>
                    ...
                    <asp:Panel ID="Panel3" runat="server" style="position: relative; top: -10px; left: 1px; height: 88px; width: 163px;">
                        <table style="width: 100%; background-color: #C0C0C0;">
                            ...
                            <tr>
                                <td>Year:&nbsp;&nbsp;</td>
                                <td>
                                    <asp:DropDownList ID="yearBeginDirTip3" runat="server" Height="25px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Month:</td>
                                <td>
                                    <asp:DropDownList ID="monthBeginDirTip3" runat="server" Height="25px" style="margin-left: 1px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Day:</td>
                                <td>
                                    <asp:DropDownList ID="dayBeginDirTip3" runat="server" Height="25px" style="margin-left: 0px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:Panel ID="Panel6" runat="server" style="position: relative; top: -10px; left: 9px; height: 85px; width: 170px;">
                        <table style="width: 100%; height: 85px; background-color: #C0C0C0;">
                            ...
                            <tr>
                                <td>Year:&nbsp;&nbsp;</td>
                                <td>
                                    <asp:DropDownList ID="yearEndDirTip3" runat="server" Height="25px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Month:</td>
                                <td>
                                    <asp:DropDownList ID="monthEndDirTip3" runat="server" Height="25px" style="margin-left: 1px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Day:</td>
                                <td>
                                    <asp:DropDownList ID="dayEndDirTip3" runat="server" Height="25px" style="margin-left: 0px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                ...
                <td>
                    <asp:Button ID="okReportDirTip3" runat="server" Font-Size="XX-Small" Text="OK" />
                    <asp:Button ID="resetReportDirTip3" runat="server" Font-Size="XX-Small" Text="Reset" />
                </td>
            </tr>
        </table>
