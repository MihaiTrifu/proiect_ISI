...
<table style="width: 760px; height: 165px; margin-right: 19px; position: relative; top: 72px; left: 16px; color: #3E5667; font-size: small; font-family: 'Book Antiqua';">
            <tr>
                <td style="border-color: #7AC0DA; width: 186px; text-align: right; font-family: 'Segoe UI'; font-size: medium; font-weight: bold; height: 77px;"><b style="font-size: small; font-family: 'Book Antiqua'">Insert Period:</b></td>
                <td style="height: 77px; ">
                    <asp:DropDownList ID="projectTip1Dir" runat="server" Height="18px" Width="302px">
                    </asp:DropDownList>
                </td>
                <td style="width: 175px">
                    <asp:Button ID="okReportTip1Dir" runat="server" Font-Size="XX-Small" Text="OK" />
                    <asp:Button ID="resetReportTip1Dir" runat="server" Font-Size="XX-Small" Text="Reset" />
                </td>
            </tr>
        </table>
