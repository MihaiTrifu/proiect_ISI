...
{
    public partial class Dir_personalAddNewTimesheet : System.Web.UI.Page
    {
        int noWorkedHours = 0;
        int noExtraHours = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (noWorkedHours > 8 && noExtraHours == 0)
            {
        ...
        {
            Response.Redirect("Dir_addTimesheet.aspx");
        }

        protected void monthlyViewButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("Dir_personalMonthlyView.aspx");
        }
    }
}