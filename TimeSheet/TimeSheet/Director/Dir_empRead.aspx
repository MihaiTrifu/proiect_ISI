       ...
       <asp:Panel ID="Panel4" runat="server" Height="398px" Width="559px">
        <table align="left" style="width: 99%; float: left; font-family: Verdana; margin-right: 0px; height: 230px;">
            <tr>
                ...
                <td>
                    <span style="font-family: 'Segoe UI'; font-size: large"><b>
                    <asp:DropDownList ID="empNameReadDir" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                    </b></span></td>
            </tr>
            <tr>
                ...
                <td style="height: 40px">
                    ...
                    <asp:DropDownList ID="yearSelectReadDir" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                    </span></td>
            </tr>
            </span><span style="font-family: 'Segoe UI'; font-size: large">
            <tr>
                ...
                <td style="height: 40px"><span style="font-family: 'Segoe UI'; font-size: large">
                    <asp:DropDownList ID="monthSelectReadDir" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                    </span></td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="daySelectReadDir" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p style="text-align: right">
                        <asp:Button ID="openReadDir" runat="server" Font-Size="XX-Small" Text="Open" OnClick="openReadDir_Click" />
                    </p>
                </td>
            </tr>
            </span>
