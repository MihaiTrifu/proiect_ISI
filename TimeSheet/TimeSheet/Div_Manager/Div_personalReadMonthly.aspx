<%@ Page Title="" Language="C#" MasterPageFile="~/Div_Manager/DivisionManager_main.master" AutoEventWireup="true" CodeBehind="Div_personalReadMonthly.aspx.cs" Inherits="TimeSheet.Div_Manager.Div_personalReadMonthly" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <aside height: 48px; right: 4px;  0px; position: relative; top: -60px;">
        ...
        <asp:Panel ID="Panel5" runat="server" style="position: relative; top: -179px; left: -2px; height: 79px; width: 178px;">
