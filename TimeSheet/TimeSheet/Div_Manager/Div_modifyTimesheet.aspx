        ...
        <table align="left" style="width: 99%; float: left; font-family: Verdana; margin-right: 0px; height: 230px;">
            <tr>
                ...
                <td style="height: 40px">
                    ...
                    <asp:DropDownList ID="yearModifyDiv" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                    </span></td>
            </tr>
            </span><span style="font-family: 'Segoe UI'; font-size: large">
            <tr>
                ...
                <td style="height: 40px"><span style="font-family: 'Segoe UI'; font-size: large">
                    <asp:DropDownList ID="monthModifyDiv" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                    </span></td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dayModifyDiv" runat="server" Height="19px" style="margin-left: 3px" ViewStateMode="Enabled" Width="287px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p style="text-align: right">
                        <asp:Button ID="modifyTsDiv" runat="server" Font-Size="XX-Small" Text="Modify" />
                    </p>
                </td>
            </tr>
            </span>
