<%@ Page Title="" Language="C#" MasterPageFile="~/Div_Manager/DivisionManager_main.master" AutoEventWireup="true" CodeBehind="Div_personalAddNewTimesheet.aspx.cs" Inherits="TimeSheet.Div_Manager.Div_personalAddNewTimesheet" %>
    ...
    <aside height: 48px; right: 4px;  0px; position: relative; top: -60px;">
        ...
        <asp:Panel ID="Panel7" runat="server" style="z-index: 1; left: 128px; top: 172px; position: absolute; height: 104px; width: 185px; margin-left: 553px; bottom: 275px;">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td>
                        <asp:Button ID="addRowsButton0" runat="server" Font-Bold="True" Font-Size="XX-Small" OnClick="addRowsButton_Click" Text="Add Rows" />
                    </td>
                </tr>
                <tr>
                    <td>
