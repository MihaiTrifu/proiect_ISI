<%@ Page Title="" Language="C#" MasterPageFile="~/Dept_Manager/DepatmentManager_main.master" AutoEventWireup="true" CodeBehind="Dept_readEmpTimesheet.aspx.cs" Inherits="TimeSheet.Dept_Manager.Dept_readEmpTimesheet" %>
    ...
    <aside height: 48px; right: 4px;  0px; position: relative; top: -60px;">
        ...
        <asp:Panel ID="PanelTabell" runat="server" style="position: relative; top: -170px; left: 10px; height: 671px; width: 526px; margin-bottom: 79px;">
            <table style="width: 100%">
                ...
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        <asp:TextBox ID="dateTextBox9" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="activityTextBox9" runat="server" Width="239px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        <asp:TextBox ID="dateTextBox10" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="activityTextBox10" runat="server" Width="239px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        <asp:TextBox ID="dateTextBox11" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="activityTextBox11" runat="server" Width="239px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        <asp:TextBox ID="dateTextBox12" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="activityTextBox12" runat="server" Width="239px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        <asp:TextBox ID="dateTextBox13" runat="server"></asp:TextBox>
                    </td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="activityTextBox13" runat="server" Width="239px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
