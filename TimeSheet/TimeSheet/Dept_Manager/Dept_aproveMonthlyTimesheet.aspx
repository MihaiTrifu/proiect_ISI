<%@ Page Title="" Language="C#" MasterPageFile="~/Dept_Manager/DepatmentManager_main.master" AutoEventWireup="true" CodeBehind="Dept_aproveMonthlyTimesheet.aspx.cs" Inherits="TimeSheet.Dept_Manager.Dept_aproveMonthlyTimesheet" %>
    ...
    <aside height: 48px; right: 4px;  0px; position: relative; top: -60px;">
        ...
        <asp:Panel ID="Panel7" runat="server" style="z-index: 1; left: 128px; top: 172px; position: absolute; height: 104px; width: 185px; margin-left: 553px; bottom: 275px;">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td>
                        <asp:Button ID="rejectButton" runat="server" BackColor="#FF3300" Font-Bold="True" Font-Size="XX-Small" OnClick="rejectButton_Click" Text="Reject" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="aproveButton" runat="server" Font-Bold="True" Font-Size="XX-Small" Text="Aprove" BackColor="#009933" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table style="width: 100%">
                ...
                <tr>
                    <td style="padding: 1px; text-align: right; width: 159px; height: 25px; font-family: 'Book Antiqua'; font-size: small; color: #3E5667; border-left-color: #A0A0A0; border-right-color: #C0C0C0; border-top-color: #A0A0A0; border-bottom-color: #C0C0C0;">
                        <b>Add-on:</b></td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:TextBox ID="reasonTextBox" runat="server" Height="168px" Width="228px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                ...
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
                        &nbsp;</td>
                    <td style="width: 258px; text-align: center; height: 25px">
                        <asp:Label ID="reasonLabel" runat="server" ForeColor="#FF3300" Text="Please insert the reason!"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; width: 159px; height: 25px">
