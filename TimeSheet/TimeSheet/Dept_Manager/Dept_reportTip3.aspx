...
<table style="width: 760px; height: 165px; margin-right: 19px; position: relative; top: 72px; left: 16px; color: #3E5667; font-size: small; font-family: 'Book Antiqua';">
            <tr>
                    ...
                    <asp:Panel ID="Panel1" runat="server" style="position: relative; top: -10px; left: 1px; height: 88px; width: 163px;">
                        <table style="width: 147%; background-color: #C0C0C0;">
                            ...
                            <tr>
                                <td>Year:&nbsp;&nbsp;</td>
                                <td>
                                    <asp:DropDownList ID="yearBeginTip3Dept" runat="server" Height="16px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Month:</td>
                                <td>
                                    <asp:DropDownList ID="monthBeginTip3Dept" runat="server" Height="16px" style="margin-left: 1px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Day:</td>
                                <td>
                                    <asp:DropDownList ID="dayBeginTip3Dept" runat="server" Height="16px" style="margin-left: 0px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:Panel ID="Panel2" runat="server" style="position: relative; top: -10px; left: 1px; height: 88px; width: 163px;">
                        <table style="width: 147%; background-color: #C0C0C0;">
                            ...
                            <tr>
                                <td>Month:</td>
                                <td>
                                    <asp:DropDownList ID="monthEndTip3Dept" runat="server" Height="16px" style="margin-left: 1px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td>Day:</td>
                                <td>
                                    <asp:DropDownList ID="dayEndTip3Dept" runat="server" Height="16px" style="margin-left: 0px" Width="93px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                ...
                <td style="width: 175px">
                    <asp:Button ID="okReportTip3Dept" runat="server" Font-Size="XX-Small" Text="OK" />
                    <asp:Button ID="resetReportTip3Dept" runat="server" Font-Size="XX-Small" Text="Reset" />
                </td>
                </b></span>
            </tr>
        </table>
