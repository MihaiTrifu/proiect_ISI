...
{
    public partial class Dept_addTimesheet : System.Web.UI.Page
    {
        ...
        protected void addTsDept_Click(object sender, EventArgs e)
        {
            setVariables();
            Response.Redirect("Dept_addNewTimesheet.aspx");
        }
